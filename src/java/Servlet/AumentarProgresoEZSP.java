 ...
 * @author illum
 */
public class AumentarProgresoEZSP extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AumentarProgresoEZSP.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
